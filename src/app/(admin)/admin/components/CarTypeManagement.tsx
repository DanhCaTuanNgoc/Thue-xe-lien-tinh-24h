      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
        ...
        <form onSubmit={onCarTypeSubmit} className="space-y-4">
          ...
          <div className="space-y-3">
            <label className="block text-sm font-semibold text-slate-700">Hình ảnh loại xe</label>
            ...
            <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
              ...
              <p className="text-sm text-slate-500 mt-2">Chọn ảnh đại diện cho loại xe</p>
            </div>
            
            {/* Image Preview */}
            {carTypeForm.image && (
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-slate-700">Ảnh đã chọn</h4>
                <div className="relative inline-block">
                  ...
                  <button
                    type="button"
                    onClick={() => onCarTypeFormChange({ ...carTypeForm, image: '' })}
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-slate-600 mt-1">
                    ...
                    {carType.description_price && (
                      <span className="ml-3">• {carType.description_price}</span>
                    )}
                  </div>
                </div>
